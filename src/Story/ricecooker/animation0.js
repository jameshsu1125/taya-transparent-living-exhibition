...
export default class Animation0 {
	constructor(props, callback) {
		const { page, bg, eyes, sweat, title, labels, imageSize } = props;

		const beginDelay = 2500;
		...
		this.tr = {
			...
			bg: {
				...
				unit: { opacity: '' },
				offset: {
					mobile: { from: { left: 40, top: 0 }, to: { left: -140, top: 0 } },
					desktop: { from: { left: 0, top: 80 }, to: { left: 0, top: -130 } },
				},
				init() {
					this.c = bg.current;
