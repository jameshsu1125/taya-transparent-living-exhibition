...
export const STORY_EARPHONE_PAGE2 = [
	{ text: '從煩雜的狀態抽離', x: -290, y: -1190, delay: 0 },
	{ text: '讓音樂傳進耳朵，歌詞佔據思緒', x: -230, y: -1120, delay: 3000 },

	{ text: '隔絕外界聲音，進入一個只有自己的空間裡', x: -150, y: -1000, delay: 5000 },
	{ text: '隔絕腦內還沒被整理的想法', x: -150, y: -930, delay: 5000 },
	{ text: '隔絕老闆，又或是隔絕自己對自己的期待', x: -150, y: -860, delay: 4000 },

	{ text: '在上班之前，再逃離一下', x: -210, y: -740, delay: 6500 },
	{ text: '隨著音樂的遞進', x: -50, y: -670, delay: 4000 },
	{ text: '慢慢、好好地開啟新的一天', x: 40, y: -600, delay: 2000 },
];
...
export const STORY_MOBILE_PAGE1 = [
	{ text: '「三八啦，剛剛再見的時候不講，現在打來說」', x: -310, y: -570, delay: 0 },
	{ text: '媽媽不好意思地說道', x: -270, y: -500, delay: 5500 },

	{ text: '「有些話不隔著手機，還是有點難說出口」', x: -230, y: -390, delay: 3500 },
	{ text: '我壓低聲音，希望她沒有發現我正在哽咽', x: -150, y: -320, delay: 7000 },
